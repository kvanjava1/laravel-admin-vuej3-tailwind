    ...
    <ContentBox title="Add New Role">
      <VForm>
        <VFormItem>
          ...
          <VFormInput name="role_name" type="text" :model-value="paramCreateRole.roleName" placeholder="Enter Name Ex: Editor"/>
        </VFormItem>
        <VFormItem>
          ...
          <div class="space-y-4 overflow-y-auto p-5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-500 focus:border-gray-500 transition duration-150 ease-in-out placeholder-gray-400">
            <div class="space-y-4" v-for="(perms, group) in groupedPermissions" :key="group">
              ...
              <div class="space-y-4 p-4 border border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-500 focus:border-gray-500 transition duration-150 ease-in-out placeholder-gray-400">
        ...
        <VFormItem>
          <VerticalMenu>
            ...
            <Button @click="clickToSaveNewRole" :disabled="loading.saveNewRole">
